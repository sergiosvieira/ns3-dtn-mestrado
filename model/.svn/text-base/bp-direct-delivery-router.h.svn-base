...
#ifndef BP_DIRECT_DELIVERY_ROUTER_H
#define BP_DIRECT_DELIVERY_ROUTER_H
 ...
 *
 * \brief Implements Direct delivery routing scheme.
 *
 *
 */

class DirectDeliveryRouter : public BundleRouter
{
 public:
...
#endif /* BP_DIRECT_DELIVERY_ROUTER__H */
